...
// Solution:
var fdPair = (targetValue, arrayInput = [] ) => {
    var pairs = [];
...
const rotString = (str1 = "", str2 = "") => {
  ...
  const str2 = "EDCBA";
  const str3 = "ABDCE";
  console.log(str1, str2, "is same", rotString(str1, str2));
  console.log(str1, str3, "is same", rotString(str1, str3));


/*Q4. Write a program to print the first non-repeated character from a string?*/
//Solution:
const notRptChar = (str) => {
    const countObj = {};
